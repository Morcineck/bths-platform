...
import com.bths.platform.motorista.MotoristaService;
...
class SecurityAuthorizationTest {
    ...
    @Test
    void deveRetornar401QuandoAcessarMotoristasSemAutenticacao()
            throws Exception {
    ...
    @Test
    void deveRetornar403QuandoStaffAcessarMotoristas()
            throws Exception {
    ...
    @Test
    void devePermitirAdminAcessarMotoristas()
            throws Exception {
        ...
        when(motoristaService.listarMotoristas())
                .thenReturn(Collections.emptyList());
